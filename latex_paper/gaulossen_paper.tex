...
Automated analysis detected 90 putative species, of which 81 (90.0\%, 95\% CI: [82.3\%, 95.1\%]) passed human verification, yielding 4,049 verified detections (species-level verification pass rate: 81/90 = 90.0\%; detection-level pass rate: 4,049/6,805 = 59.5\%, Table \ref{tab:verification}).
